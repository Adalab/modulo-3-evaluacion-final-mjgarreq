    ...
    <Routes>
      <Route path="/" element={
        <>
          ...
          {filterCharacters.length !==0 ? <CharacterList characters={filterCharacters}/> : <><section className='section-error'><p className='error-msg'>No se han encontrado resultados con esa búsqueda.</p></section></>} 
